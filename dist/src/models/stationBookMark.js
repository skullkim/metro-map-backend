...
var StationBookMark = /** @class */ (function (_super) {
    __extends(StationBookMark, _super);
    ...
    StationBookMark.setBookMark = function (userEmail, from, to, stopover) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_1.User.getUser(userEmail)];
                    case 1:
                        user = _a.sent();
    ...
    StationBookMark = StationBookMark_1 = __decorate([
        (0, typeorm_1.Entity)()
    ], StationBookMark);
