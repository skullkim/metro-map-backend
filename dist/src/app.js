...
var minCostValue_1 = require("./entity/minCostValue/minCostValue");
// import { MinCostValueRepo } from './entity/minCostValue/minCostValueRepo';
/* eslint-disable */
(0, typeorm_1.createConnection)().then(function (connection) {
    ...
    app.get('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var minCostVal, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, minCostValue_1.MinCostValue.getMinCostValue("102", "901")];
                case 1:
                    minCostVal = _a.sent();
                    res.send(minCostVal);
                    return [3 /*break*/, 3];
