...
var validateEmail = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                exUser = _a.sent();
                if (!(0, auth_1.isValidEmail)(email) || !exUser) {
                    res.status(400);
                    return [2 /*return*/, res.json((0, fail_1.jsonErrorResponse)(req, { message: auth_2.ErrorMessage.InvalidEmail }))];
                }
                else if (exUser && exUser.checkedEmail) {
                    res.status(409);
                    return [2 /*return*/, res.json((0, fail_1.jsonErrorResponse)(req, { message: auth_2.ErrorMessage.EmailAlreadyVerified }, 409))];
                }
